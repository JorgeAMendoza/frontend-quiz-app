...
it('it should render the Theme Component', () => {
  render(<ThemeToggle />)
})

it('should by default have the light option toggled', () => {
  render(<ThemeToggle />)
...
it('should toggle the theme to dark when dark option is clicked', async () => {
